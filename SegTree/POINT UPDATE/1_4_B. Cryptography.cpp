...
struct SegTree
{
    ...
    Mat merge(const Mat &x, const Mat &y)
    {
        Mat res;
    ...
    void build(vector<Mat> &a, int v, int tl, int tr)
    {
    ...
    Mat query(int v, int tl, int tr, int l, int r)
    {
        ...
        {
            Mat left = query(v * 2, tl, tm, l, tm);
            Mat right = query(v * 2 + 1, tm + 1, tr, tm + 1, r);
